...
class UserController extends Controller
{
     ...
     */
    public function update(UpdateUserRequest $request, SearchUserRequest $id)
    {
        $user = User::find($id->all()['id']);
     ...
     */
    public function destroy(SearchUserRequest $id)
    {
        User::destroy($id->all()['id']);
